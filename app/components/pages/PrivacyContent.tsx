...
const T: Record<Locale, {
  ...
  ja: {
    ...
    sections: [
      {
        h: "1. 個人情報の取扱い方針について",
        body: ["株式会社志成コンサル（以下「当社」といいます）は、補助金・助成金の申請代行および関連する相談サービスを提供する過程で、お客様の個人情報を取得します。当社は個人情報保護の重要性を十分に認識し、日本の「個人情報保護法」および関連法令を遵守して、個人情報を適切に取り扱います。"],
      },
      {
        h: "2. 収集する個人情報の範囲",
        ...
        list: [
          ...
          "補助金・助成金の申請代行の過程で：申請書類の作成に必要な法人登記情報、財務・納税関連資料、雇用関連資料など（お客様が代行をご依頼のうえ同意された場合にのみ取得します）",
        ],
      },
      {
        h: "3. 個人情報の利用目的",
      ...
      },
      {
        ...
        list: [
          "本人の同意を得ている場合",
          "補助金・助成金を申請するため、主管行政機関、事務局、または申請を補助する有資格の専門家（行政書士・税理士・社会保険労務士・中小企業診断士など）に必要な情報を提供する必要がある場合（お客様が代行をご依頼のうえ同意された場合にのみ）",
          "法令に基づき提供する必要がある場合",
