...
const T: Record<Locale, {
  ...
  zh: {
    ...
    contacts: [
      ...
      { label: "电话 Tel", value: "03-6205-6789" },
      { label: "邮箱 Email", value: "info@shisei-consult.jp" },
      { label: "地址 Address", value: "〒133-0051 東京都江戸川区北小岩6-39-2 方円ビル301号" },
    ],
  ...
  ja: {
    ...
    contacts: [
      ...
      { label: "電話", value: "03-6205-6789" },
      { label: "メール", value: "info@shisei-consult.jp" },
      { label: "住所", value: "〒133-0051 東京都江戸川区北小岩6-39-2 方円ビル301号" },
    ],
