...
const T: Record<Locale, {
  ...
  zh: {
    ...
    heroDesc: "从初次咨询到资金到账，全程中文陪同。不获批不收成功报酬，服务范围、着手金及实费在签约前说明。",
    ...
    steps: [
      ...
      { n: "10", title: "实绩报告与支给申请", duration: "实施完毕后 1〜3 个月", desc: "实绩报告审核通过后入金；成功报酬原则上在入金后按合同支付。", you: "提供实施证据", we: "实绩报告制作、入金确认" },
    ],
    afterLabel: "採択后仍需 3〜6 个月：08〜10 步决定最终能否入金",
    youLabel: "您需要", weLabel: "我们负责",
    feeEyebrow: "费用", feeHeading: "费用与成功报酬",
    fee: [companyClaims.zh.feeRate, companyClaims.zh.feeScope, companyClaims.zh.feeTiming, "补助金为事后支付，需自筹周转资金；可协助对接政策融资。"],
    faqs: [
      { q: "全程需要多长时间才能拿到补助金？", a: "从初次咨询到资金到账，通常需要6个月〜1年。省力化补助金约3〜6个月，AI导入补助金约2〜3个月，具体时间轴在初次咨询时会详细说明。" },
      { q: "如果申请失败，需要支付费用吗？", a: companyClaims.zh.feeScope },
      ...
      { q: "成功报酬是多少？", a: companyClaims.zh.feeRate },
  ...
  en: {
    ...
    heroDesc: "From your first inquiry to disbursement, we support you in Chinese. No approval, no success fee; scope, any retainer and expenses are explained before signing.",
    ...
    steps: [
      ...
      { n: "10", title: "Final report & payment", duration: "1–3 months after completion", desc: "Disbursement follows report approval; the success fee is normally due after funds arrive, per contract.", you: "Provide evidence", we: "Final report and disbursement confirmation" },
    ],
    ...
    fee: [companyClaims.en.feeRate, companyClaims.en.feeScope, companyClaims.en.feeTiming, "Subsidies are reimbursed after the fact; we can help arrange policy loans."],
    faqs: [
      ...
      { q: "If the application fails, do I have to pay?", a: companyClaims.en.feeScope },
      ...
      { q: "How much is the success fee?", a: companyClaims.en.feeRate },
  ...
  ja: {
    ...
    heroDesc: "初回相談から受給まで、全工程を中国語でサポート。不採択時は成功報酬なし。業務範囲・着手金・実費は契約前にご案内します。",
    ...
    steps: [
      ...
      { n: "10", title: "実績報告・支給申請", duration: "完了後1〜3か月", desc: "実績報告の承認後に入金。成功報酬は原則入金後、契約書に従いお支払い。", you: "実施証拠の提供", we: "実績報告作成・入金確認" },
    ],
    afterLabel: "採択後さらに3〜6か月：08〜10で入金の可否が決まります",
    youLabel: "お客様", weLabel: "当社",
    feeEyebrow: "費用", feeHeading: "費用と成功報酬",
    fee: [companyClaims.ja.feeRate, companyClaims.ja.feeScope, companyClaims.ja.feeTiming, "補助金は後払いのため自己資金が必要。政策融資のご紹介も可能。"],
    faqs: [
      { q: "受給までに全体でどのくらいかかりますか？", a: "初回相談から受給まで、通常6か月〜1年かかります。省力化補助金は約3〜6か月、AI・IT導入補助金は約2〜3か月で、具体的なスケジュールは初回相談で詳しくご説明します。" },
      { q: "申請が不成功の場合、費用は必要ですか？", a: companyClaims.ja.feeScope },
      ...
      { q: "成功報酬はいくらですか？", a: companyClaims.ja.feeRate },
