  ...
  <nav className="nav">
    <div className="nav-inner">
      ...
      <div className="nav-links">
        ...
        <Link href="/cases" className="nav-link active">成功案例</Link>
...
const cases: CaseItem[] = [
  {
    ...
    amount: "2,000万円",
    period: "约3个月",
    quote: "受疫情影响，堂食收入骤降超40%。志成コンサル帮我们规划了外卖+预制菜业务转型方案，成功获批2000万补助金，完成厨房设备升级和线上运营系统搭建，现在外卖营业额已占总收入的55%。",
    color: "#f97316",
  },
  {
    industry: "美容行业",
    ...
    amount: "450万円",
    period: "约2个月",
    quote: "之前一直用纸质预约本，漏单、撞单情况不断。顾问建议我们申请IT导入补助，引入一套预约管理+会员CRM系统，费用几乎全额报销。现在客户复购率提升了30%，省了大量人工。",
    color: "#ec4899",
  },
  {
    industry: "IT·软件",
    ...
    amount: "1,000万円",
    period: "约4个月",
    quote: "我们想开发一套面向中小企业的AI自动化工具，但研发成本压力很大。志成コンサル协助撰写了详细的技术创新方案，顺利通过审查，获批1000万円研发补贴，让我们提前两年实现了产品化目标。",
    color: "#6366f1",
  },
  {
    industry: "建设·装修",
    ...
    amount: "200万円",
    period: "约6周",
    quote: "公司规模不大，就5个人，一直不知道能申请什么补助。顾问推荐了最适合小规模公司的持续化补助金，帮我们更新了施工设备并制作了中日双语营销资料，拿到200万円，整个申请过程非常顺畅。",
    color: "#0ea5e9",
  },
  {
    industry: "零售·电商",
    ...
    amount: "1,500万円",
    period: "约3.5个月",
    quote: "我们在名古屋开了家日本酒零售店，受疫情影响外国游客断绝，实体店经营困难。志成コンサル帮助我们制定跨境电商转型计划，面向中国和东南亚市场，获批1500万円，实现了线上线下双轨经营。",
    color: "#14b8a6",
  },
  {
    industry: "教育·培训",
    ...
    amount: "350万円",
    period: "约2个月",
    quote: "学校想引入线上课程管理平台和互动教学软件，但预算有限。志成コンサル识别出我们符合IT导入补助金的条件，全程用中文辅导我们完成申请，最终获批350万円，成功上线了线上教学系统。",
    color: "#a855f7",
  },
  {
    industry: "制造·加工",
    ...
    amount: "3,000万円",
    period: "约5个月",
    quote: "工厂的自动化改造一直是最大瓶颈，人工成本居高不下。志成コンサル的团队帮我们做了非常专业的技术创新计划书，成功申请到3000万円设备升级补助，现在生产效率提升了45%，残次品率下降了60%。",
    color: "#22c55e",
  },
  {
    industry: "物流·运输",
    ...
    amount: "1,800万円",
    period: "约4个月",
    quote: "我们想从传统货运转型做冷链物流，需要购置冷藏车和建设冷库，资金缺口很大。志成コンサル制定了完整的事业再构筑计划，获批1800万円补助，让我们成功打入高端冷链市场，年营业额增长超80%。",
    color: "#f59e0b",
  },
];
