...
export const metadata: Metadata = {
  ...
  description:
    "专为在日华人企业主提供日本政府补助金全程代办服务。省力化补助金、AI导入补助金、员工转正助成金等全程中文办理，行政书士·社会保险劳务士·税理士·中小企业诊断士联合团队，不获批不收成功报酬。",
  keywords: [
    "在日华人补助金",
    "日本补助金申请",
    "省力化补助金",
  ...
  openGraph: {
    ...
    description:
      "专为在日华人企业主提供日本政府补助金全程代办服务。全程中文，不获批不收成功报酬。行政书士·税理士·社劳士·诊断士联合团队。",
  ...
  twitter: {
    ...
    title: "志成コンサル | 在日华人补助金申请代办",
    description:
      "专为在日华人企业主提供日本政府补助金全程代办服务。全程中文，不获批不收成功报酬。",
