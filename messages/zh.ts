...
export const zh = {
  ...
  hero: {
    ...
    trust: ["全程中文", "四类国家认定专家", "不获批不收成功报酬", "3,000+ 件获批案件※"],
    stats: [
      { val: "3,000+", label: "累计获批案件", note: "餐饮·零售·制造·IT" },
      { val: "¥8.5億+", label: "累计获批金额", note: "交付决定／支给决定合计" },
  ...
  home: {
    ...
    who: [
      ...
      { t: "看截止时间", d: "省力化第 8 回、AI導入 9/29、持続化第 20 回、东京空调第 4 回——官方日期每月核验。", a: "查看公募日历", href: "/schedule" },
    ],
    ...
    panelBadge1: "成功报酬制",
    panelBadge2: "不获批不收成功报酬。",
    reasons: [
      { title: "全程中文，无语言障碍", desc: "从初次咨询到资金到账，所有日语文件由我们的专业人员处理，您只需提供企业信息。" },
      { title: companyClaims.zh.noSuccessFee, desc: companyClaims.zh.feeScope },
      { title: "四类国家认证专家全程操办", desc: "行政书士、社劳士、税理士、经营诊断士分工协作，覆盖补助金申请全环节。" },
      { title: "3,000+ 件获批案件", desc: "累计协助在日华人企业获批补助金·助成金 3,000 余件，覆盖餐饮、IT、制造、美容等多个行业。" },
    ],
    ...
    steps: [
      ...
      { n: "05", title: "获批到账", desc: companyClaims.zh.feeTiming },
    ],
  ...
  // ── CTA 组件默认值 ──
  cta: {
    descDefault: "3分钟免费问诊，为您的企业精准匹配最优补助金方案。全程中文，不获批不收成功报酬。",
    primaryDefault: "立即免费诊断",
    secondaryDefault: "查看补助金种类",
    guarantees: [
      [companyClaims.zh.noSuccessFee, "着手金及实费如有，签约明示；中途撤回等按合同约定"],
