...
export const zh = {
  ...
  hero: {
    ...
    trust: ["全程中文", "四类国家认定专家", "不获批不收费", "3,000+ 件获批案件※"],
    stats: [
      { val: "3,000+", label: "累计获批案件", note: "餐饮·零售·制造·IT" },
      { val: "¥8.5億+", label: "累计获批补助金", note: "已获交付决定合计" },
      { val: "4 种", label: "国家认定专业资质", note: "行政书士·社劳士·税理士·诊断士" },
    ],
    statsNote: "※ 以上为自成立以来累计口径（截至 2026 年 8 月）：累计获批案件=已获交付决定/支給決定的申请案件数（1 家企业多件按件计）；累计获批补助金=上述案件的交付决定金额合计（非到账金额）；通过率=已完成审查案件的採択比例。个案结果以主管机关审查为准，不构成获批承诺。",
  },
