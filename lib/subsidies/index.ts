...
export const detailUI: Record<Locale, {
  ...
  zh: {
    ...
    sidebarDesc: `3分钟问卷，专业顾问1个工作日内给出诊断结果，全程中文。${companyClaims.zh.noSuccessFee}，其他费用以合同约定为准。`,
    sidebarCta: "开始免费诊断", sidebarAlt: "也可直接联系我们",
    sidebarWechat: "企业微信：扫码添加营业部", sidebarPhone: "电话：03-6205-6789",
    otherSubsidies: "其他补助金", viewAll: "查看全部补助金 →",
    bottomTitlePre: "申请", bottomTitleHighlight: "从咨询到领取全程代办",
    bottomDesc: `行政书士·社会保险劳务士·税理士组成的专业团队，全程中文支持。${companyClaims.zh.feeScope}`,
  ...
  en: {
    ...
    sidebarDesc: `A 3-minute questionnaire; an advisor responds within 1 business day. Full Chinese-language support. ${companyClaims.en.noSuccessFee}; other charges follow the written agreement.`,
    sidebarCta: "Start Free Diagnosis", sidebarAlt: "Or contact us directly",
    sidebarWechat: "WeChat Work: scan to add Sales Dept.", sidebarPhone: "Phone: 03-6205-6789",
    ...
    bottomDesc: `A professional team of Gyoseishoshi, Sharoshi and Zeirishi provides full Chinese-language support. ${companyClaims.en.feeScope}`,
  ...
  ja: {
    ...
    sidebarDesc: `3分のアンケートで、専門顧問が1営業日以内にご回答。全工程中国語対応。${companyClaims.ja.noSuccessFee}。その他の費用は契約の定めに従います。`,
    sidebarCta: "無料診断を始める", sidebarAlt: "直接のお問い合わせも可能です",
    sidebarWechat: "企業WeChat：QRで営業部を追加", sidebarPhone: "電話：03-6205-6789",
    otherSubsidies: "その他の補助金", viewAll: "すべての補助金を見る →",
    bottomTitlePre: "の申請を", bottomTitleHighlight: "相談から受給まで全面代行",
    bottomDesc: `行政書士・社会保険労務士・税理士の専門チームが、全工程を中国語でサポート。${companyClaims.ja.feeScope}`,
