...
// 补助金详情页数据（5个补助金）。slug 三语共用；en/ja 由翻译填充。
...
export const subsidiesZh: SubsidyData[] = [
  {
    slug: "seiryoka",
    tag: "省力化",
    name: "省力化补助金（一般型）",
    ...
    deadline: `截止：${DATES.seiryoka.deadline}（日本时间）`,
    metaTitle: "省力化补助金一般型能补多少？5人以下750万·6〜20人1,500万，第8回9月受付",
    metaDesc: `在日华人企业导入自动化设备·DX系统：补助上限按员工数分5档（750万〜8,000万円），补助率1/2、小规模2/3。第8回 ${DATES.seiryoka.opens} 受付、${DATES.seiryoka.deadline} 截止（日本时间）。3分钟自测能否申请，中文一对一代办。`,
    ...
    note: `第 8 回申请受付为 ${DATES.seiryoka.opens} 至 ${DATES.seiryoka.deadline}（日本时间）。日程于 ${DATES.seiryoka.verifiedAt} 对照官方日程页复核；本页其他金额与要件沿用下方所列核验日资料，提交前须确认最新公募要领。省力化一般型为审查採択制，提交申请不保证採択。`,
  },
  {
    slug: "ai-it",
    tag: "AI导入",
    ...
    deadline: `截止：${DATES["ai-it"].deadline}（日本时间）`,
    metaTitle: "AI导入补助金2026怎么申请？通常枠最高450万円，中文代办全流程",
    metaDesc: "买AI软件·上系统·做定制开发：デジタル化・AI導入補助金通常枠5万〜450万円，补助率1/2（满足最低工资要件2/3）。必须和登记的IT导入支援事业者共同申请、有公募截止。个人事业主·赤字企业可评估，先免费诊断。",
    ...
    verifiedDate: "2026-08-01",
    note: `通常枠第 5 次截止为 ${DATES["ai-it"].deadline}（日本时间），由登记的 IT 导入支援事业者共同申请；后续轮次以官方日程页公布为准。日程于 ${DATES["ai-it"].verifiedAt} 复核；本页其他金额与要件沿用下方所列核验日资料，提交前须确认最新公募要领。提交申请不保证採択。`,
  },
  {
    slug: "career-up",
    tag: "助成金",
    ...
    metaTitle: "员工转正能拿多少助成金？有期→正规最高80万円/人，2026年新增情報公表加算",
    metaDesc: "キャリアアップ助成金正社員化コース：有期→正規·重点支援对象80万/人、其他40万/人，无期→正規40/20万/人（中小企业·2期支给）。2026年4月起情報公表加算20万円/事業所。通年受付，转换前1个月须先交计划书——先免费确认资格。",
  ...
  },
  {
    ...
    metaTitle: "员工培训费政府补多少？人材開発支援助成金经费45%〜75%＋赁金助成800〜1,000円/时",
    metaDesc: "给员工上AI·DX·专业技能课：中小企业经费助成率45%〜75%，另加每人每小时800〜1,000円赁金助成；事业所年度上限按コース1,000万〜1亿円。培训开始前1个月须提交计划。看你的课程能否认定，先免费诊断。",
  ...
  },
  {
    ...
    deadline: `截止：${DATES.aircon.deadline}（日本时间）`,
    metaTitle: "东京都换空调补助多少？最高4,500万円·助成率3/4，第4回9/16〜10/2受付",
    metaDesc: "东京都ゼロエミッション省エネ設備導入助成：年减CO2 28t以上助成率3/4上限4,500万；诊断后减3t或30%上限2,500万（2/3）；自作计划上限1,000万（2/3）。交付决定后才能签合同、超额抽签。第4回2026-09-16〜10-02，先免费判断档位。",
    ...
    verifiedDate: "2026-08-01",
    note: `第 4 回受付为 ${DATES.aircon.opens} 至 ${DATES.aircon.deadline}（日本时间），超预算时对受付期间内的申请抽签。日程及事业期限于 ${DATES.aircon.verifiedAt} 对照官方页面复核：事业实施至令和 8 年度，助成金交付至令和 9 年度。本页其他金额与要件沿用下方所列核验日资料，提交前须确认最新募集要项。`,
  },
];
