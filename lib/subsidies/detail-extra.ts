...
export const DETAIL_EXTRA_UI: Record<Locale, {
  ...
  zh: {
    ...
    midCtaT: "这项制度适合你的企业吗？", midCtaD: "4 个问题，1 个营业日内中文回复。不获批不收成功报酬。", midCtaBtn: "免费确认申请条件",
    you: "您需要", we: "我们负责",
  ...
  ja: {
    ...
    midCtaT: "この制度は貴社に合いますか？", midCtaD: "4つの質問に答えるだけ、1営業日以内に回答。不採択時は成功報酬なし。", midCtaBtn: "無料で申請条件を確認",
    you: "お客様", we: "当社",
