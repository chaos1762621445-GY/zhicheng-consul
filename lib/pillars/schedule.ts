...
export const schedule: PillarSet = {
  ...
  en: {
    ...
    ctaDesc: "Tell us the program and your status; we reply within one business day with a reverse timeline. No approval, no success fee.",
  ...
  ja: {
    ...
    ctaTitle1: "この回を狙うなら ",
    ctaTitle2: "まず3分の無料診断",
    ctaDesc: "目標制度と現状をお知らせください。1営業日以内に「間に合うか・今やること」の逆算表をご回答。不採択時は成功報酬をいただきません。",
